...
-- Stricter motion filter to ensure wall straightness
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.05)
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.1

-- CRITICAL: Increase constraint matching scores to enforce map quality
-- Higher scores = stricter matching = straighter walls
POSE_GRAPH.constraint_builder.min_score = 0.75
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.80

-- Optimize every 90 nodes to refine map continuously
